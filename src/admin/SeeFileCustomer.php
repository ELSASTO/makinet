...
<body>
    <div id="app">
        <v-app id="inspire">
            ...
            <v-navigation-drawer v-model="drawer" app :style="style.header">
            ...
            <v-main wrap :style="style.bg_system">
		        <v-container fluid>
                    <Filecustomer title="<?php echo $_GET['id']?>" business="<?php echo $_GET['business'] ?>"/>
                </v-container>
            </v-main>
        </v-app>
    </div>
    ...
    <!-- vuejs -->
    <script src="../views/Admin/SeeFileCustomer.js"></script>
