		...
		<div class="mb-10 pa-8">		
			...
			<v-row>
				<v-col cols="12" sm="12" md="8" lg="8" xl="8">
					<v-card flat :style="style.v_cardindigo" class="mb-6 pa-2 rounded-xl" color="indigo accent-3" dark>
						<v-card-text>
					...
					<v-row>
						...
						<v-col cols="12" sm="12" md="5" lg="5" xl="5">
							<v-card flat :style="style.v_card" :loading="loadingGraphicsPie" class="mb-6 rounded-xl">
								<v-card-title>
									<span class="text--secondary subtitle-1">{{Statistics_desc.requestsTotalTitle}}</span>
								</v-card-title>
								<v-card-text>
					...
					<v-skeleton-loader
						...
						<v-card flat :style="style.v_card" class="rounded-xl">
							<v-card-title>
								<span class="text--secondary subtitle-1"> {{ Statistics_desc.customers }} </span>
							</v-card-title>
							<v-divider></v-divider>
							<v-card-text>
								...
								>
									<thead>
										<th class="text-left text--secondary"> Id </th>
										<th class="text-left text--secondary"> Cliente </th>
										<th class="text-left text--secondary"> Cantidad Solicitudes </th>
										<th class="text-left text--secondary"> Total </th>
										<th class="text-left text--secondary"> Saldo </th>
									</thead>
									<tbody>
										<tr
				...
				<v-col cols="12" sm="12" md="4" lg="4" xl="4">
					...
					<v-card :style="style.v_cardpurple" class="mb-6 rounded-xl" color="deep-purple accent-3" dark>
						<v-card-text>
							<v-row no-gutters align="center" justify="center">
								<v-col cols="8" sm="8" md="8" lg="8" xl="8">
