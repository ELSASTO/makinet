		...
		<div fluid class="mb-10 pa-8">
			...
			<v-row>
                ...
                <v-col cols="12" sm="12" md="12" lg="3" xl="3">
                    <!-- input para filtrar los datos de las solicitudes -->
                    <v-card flat :style="style.v_card" class="rounded-xl mb-6">
                        <v-card-text>
                            <span>Cantidad solicitudes por usuario</span>
                            <v-row align="center">
					...
					<v-card :style="style.v_card" class="mb-6 rounded-xl" v-if="asignado != 0 || asignado != ''">
						<v-card-text>
							<v-row no-gutters align="center" justify="center">
								<v-col cols="8" sm="8" md="8" lg="8" xl="8">
                                    <span class="text--secondary">Actividades asignadas:</span><br>
									<span class="text--secondary headline"> {{ asignado }} </span>
								</v-col>
								<v-col cols="4" sm="4" md="4" lg="4" xl="4">
									<div class="text-right pa-4">
										<v-icon color="red accent-3"> mdi-file-alert-outline mdi-24px </v-icon>
									</div>
								</v-col>
							</v-row> 
						</v-card-text>
					</v-card>
                    <!-- Actividades Otros procesos -->
					<v-card :style="style.v_card" class="mb-6 rounded-xl" v-if="otros != 0 || otros != ''">
						<v-card-text>
							<v-row no-gutters align="center" justify="center">
								<v-col cols="8" sm="8" md="8" lg="8" xl="8">
                                    <span class="text--secondary">Actividades en proceso:</span><br>
									<span class="text--secondary headline"> {{ otros }} </span>
								</v-col>
								<v-col cols="4" sm="4" md="4" lg="4" xl="4">
									<div class="text-right pa-4">
										<v-icon color="orange accent-4">mdi-file-clock-outline mdi-24px </v-icon>
									</div>
								</v-col>
							</v-row>
						</v-card-text>
					...
					<v-card :style="style.v_card" class="mb-6 rounded-xl" v-if="finalizado != 0 || finalizado != ''">
						<v-card-text>
							<v-row no-gutters align="center" justify="center">
								<v-col cols="8" sm="8" md="8" lg="8" xl="8">
									<span class="text--secondary">Actividades Finalizadas:</span><br>
									<span class="text--secondary headline"> {{ finalizado }} </span>
								</v-col>
								<v-col cols="4" sm="4" md="4" lg="4" xl="4">
									<div class="text-right pa-4">
										<v-icon color="green accent-4"> mdi-file-check-outline mdi-24px </v-icon>
									</div>
								</v-col>
							</v-row>
						</v-card-text>
