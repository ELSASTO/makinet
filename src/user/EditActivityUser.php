...
<body>
    <div id="app">
        <v-app id="inspire">
            ...
            <v-navigation-drawer v-model="drawer" app color="deep-purple accent-4" dark>
            ...
            <v-main wrap :style="style.bg_system">
		        <v-container fluid>
                    <Editactivity title="<?php echo $_GET['id']?>"/>
                </v-container>
            </v-main>
        </v-app>
    </div>
    ...
    <script src="../views/User/EditActivityUser.js"></script>
