...
<body>
    <div id="app">
        <v-app id="inspire">
            ...
            <v-app-bar app flat color="white" :style="style.header" class="ma-4 rounded-lg">
    ...
    <script src="../views/User/CreateTaskUser.js"></script>
    <script src="../views/User/CreatePiecesUser.js"></script>
